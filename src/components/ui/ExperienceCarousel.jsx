...
const ExperienceCarousel = ({experience, onClick}) => {
    return (
      <div className='d-flex justify-content-center align-items-center flex-column experience'>
        ...
        <div className='d-flex flex-row align-items-center experience-content'>
          <img src={arrow} className='button-left clickable' alt='left arrow' onClick={() => {onClick('prev')}} />
          ...
          <img src={arrow} className='button-right clickable' alt='right arrow' onClick={() => {onClick('next')}} />
        </div>
      </div>
    );
};
